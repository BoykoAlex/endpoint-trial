...
public class CompilationResult {
	...
	private List<CompiledClassDefinition> compiledClassDefinitions;
	...
	public void setCompiledClassDefinitions(List<CompiledClassDefinition> classDefs) {
		this.compiledClassDefinitions = classDefs;
	}
	
	public List<CompiledClassDefinition> getCompileClassDefinitions() {
		return this.compiledClassDefinitions;
	}
